...
korzystające ze zgromadzonych danych w celu wspomagania
...
do różnych protokołów sieci przemysłowych i IoT. Potrzebna jest też integracja
...
\subsection{Ogólna koncepcja rozwiązania}



\subsection{Komponentowy model architektury}

\subsection{Specyfikacja prototypu}

\todo{Opisać implementację modelu}
