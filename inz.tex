...
\newcommand{\autor}{Michał Rzepka}
\newcommand{\promotor}{dr hab. inż., prof. PŚ Piotr Gaj}
\newcommand{\tytul}{System IIoT do zbierania danych pomiarowych}
...
\fancypagestyle{skroty}{%
      \fancyhf{}
      \fancyhead[LE]{\thepage}
      \fancyhead[RE]{Spis skrótów i symboli}
      \fancyhead[LO]{Spis skrótów i symboli}
      \fancyhead[RO]{\thepage}
}
