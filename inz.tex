...
Z efektów działania projektowanego systemu niekoniecznie bezpośrednio muszą korzystać wyłącznie
...
danych z wielu różnych urządzeń. Jako że główną funkcjonalnością projektowanego
systemu jest zbieranie danych pomiarowych, użycie rozwiązań z dziedziny IoT 
jest się wyborem uzasadnionym. Zadaniem krytycznym w systemach IoT jest 
przetwarzanie zebranych danych. Problem ten adresują oferowane za pośrednictwem Internetu
...
Drugim założeniem podstawowym zawartym w temacie niniejszej pracy
jest ukierunkowanie projektowanego systemu na zastosowanie w przemyśle. 
Rozpatrywane wymaganie obejmuje kilka aspektów. Pierwszym z nich jest cel
zbierania danych pomiarowych z zastosowaniem rozwiązań IoT, 
który w środowisku przemysłowym sprowadza się do zapewnienia większej wydajności,
zrównoważenia i wiedzy na temat procesów przemysłowych. Intencją IIoT nie jest
natomiast zastąpienie istniejących, dedykowanch systemów automatyzacji, w skład 
których wchodzi także aparatura pomiarowa. Aczkolwiek
własnością porządaną projektowanego systemu jest możliwość integracji



\subsubsection{Ogólność rozwiązania}

\subsubsection{Skalowalność, konfigurowalność}
