...
Model zrealizowanego prototypu przedstawiono na rys. \todo{dodać}.
...
Komponent \texttt{Oprogramowania} obu bram (patrz: rys. , rozdział. \todo{dodać})zaimplementowano z wykorzystaniem
...
przedstawiono na rys. \todo{dodać rys}. Zdefiniowano następujące klasy:
\begin{itemize}
      \itemsep0em
...
Na potrzeby realizacji komponentu \texttt{Bufora Brzegowego} (patrz: \todo{xd})
zaprojektowano własny węzeł Node-RED o nazwie \texttt{EdgeBuffer}.
Jego model przedstawiono na rys. \todo{dodać}.
