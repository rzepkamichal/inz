...
Zestaw urządzeń AKPiA można zamodelować zbiorem informacji, który nazywa się
...
cyfrowe odwzorowanie (bliźniak) cech i atrybutów rzeczywistego obiektu \cite{isp}, \cite{iiot-challenges-opportunities-directions}.
...
HTTP, RTP, SMTP. Wśród protokołów najwyższych warstw opracowano również
...
reprezentujące tzw. czwartą rewolucję przemysłową. Jest to koncept stosunkowo uniwersalny
...
następuje projekt, rozwój i prototypownie (powstaje tzw. ,,typ produktu``), a w
...
\cite{iiot-challenges-opportunities-directions}, 
\cite{industry4-ref-models}, \cite{rami4}.


\begin{figure}[H]
      \centering
      \includegraphics[width=0.72\textwidth]{RAMI4.png}
