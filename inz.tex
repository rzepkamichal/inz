...
danych z wielu różnych urządzeń. Użycie rozwiązań z dziedziny IoT jest więc wyborem uzasadnionym. 
Zadaniem krytycznym w systemach IoT jest przetwarzanie zebranych danych. 
Problem ten adresują m.in. oferowane za pośrednictwem Internetu
usługi chmurowe. Tak więc Internet Rzeczy i~przetwarzanie w~chmurze w~stopniu 
znaczącym odpowiadają na 
...
jednolitego formatu danych na poziomie warstwy aplikacji}, który ma zapewnić przenośność,
łatwą wymianę danych pomiędzy współpracującymi systemami danych pomiędzy. Formaty
te powinny być uprzednio specyfikowane, a projektowany system powinien być do 
nich zaadaptowany --- analogiczni,e jak w przypadku protokołów.
